      ...
      <div className="items text-center">
        ...
        <div className="flex gap-7 items-center justify-center my-8 flex-wrap">
          {PricePlanSectionData.map((item)=>(
            <div key={item.Id} className="bg-white px-24 py-12 items-center flex flex-col gap-3 w-fit">
              ...
              <button className="my-4 bg-blue-700 hover:bg-blue-800 p-3 text-white text-sm font-semibold rounded-l">Get Started Now</button>
            </div>
          ))}
        </div>
      </div>
